...
def run():
    ...
    st.write(""" [🟢 - Réalisez un test avec une image de poumons présentant un état sain](https://drive.google.com/uc?export=download&id=1fgE3NHSKh9izh9ufKzGfccHIkTYBF2wC)""")
    st.write(""" [🔴 - Réalisez un test avec une image de poumons présentant un état cancéreux](https://drive.google.com/uc?export=download&id=1swkOcKNC1JlYbgEhUDNAliF4numUEUod)""")
